#*****************************************************************************
#Wheat
# FBS or GCAM: "Wheat and products"
...
bal %>% Proc_primarize(
  ...
  Proc_primarize(
    ...
    c("Gluten, wheat", "Starch, wheat", "Bread", "Pastry", "Macaroni",
      "Wafers", "Mixes and doughs")) -> bal_PE  #primary equivalent
...
#Map to GCAM regions
bal_PE %>% Proc_primarize_aggregate(Primary_crop = "Wheat")-> bal_APE_new
...
#Proc_primarize
bal -> bal_PE  #primary equivalent
#Aggregate to Primary equivalent and keep Primary: Maize and product
#Map to GCAM regions
bal_PE %>% Proc_primarize_aggregate(Primary_crop = "Wheat and products")-> bal_APE_old
